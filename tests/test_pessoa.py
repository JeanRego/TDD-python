...
class TestPessoa(unittest.TestCase):
    def setUp(self):
        self.p1 = Pessoa('Jean','Rego')
        self.p2 = Pessoa('Isa','Medeiros')
        
    def test_pessoa_attr_nome_tem_o_valor_correto(self):
        self.assertEqual(self.p1.nome, 'Jean')
        self.assertEqual(self.p2.nome, 'Isa')
    ...
    def test_pessoa_attr_sobrenome_tem_o_valor_correto(self):
        self.assertEqual(self.p1.sobrenome, 'Rego')
